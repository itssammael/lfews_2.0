                                    ...
                                    <Dropdown align="right" width="48">
                                        <template #trigger>
                                            ...
                                            <span v-else class="inline-flex rounded-md">
                                                <button type="button" class="uppercase inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-800 dark:text-gray-400 bg-transparent dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:bg-gray-50 dark:focus:bg-gray-700 active:bg-gray-50 dark:active:bg-gray-700 transition ease-in-out duration-150">
                                        ...
                                        <template #content>
                                            ...
                                            <form @submit.prevent="logout">
                                                <DropdownLink as="button">
                                                    <span class="uppercase text-gray-900">Log Out</span>
                                                </DropdownLink>
                                            </form>
                                        </template>
                                    </Dropdown>
