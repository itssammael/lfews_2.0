      ...
      <div class="w-full space-y-12 bg-gray-200/[0.25]">
        ...
        >
          ...
          <div class="overflow-hidden">
            ...
            >
              ...
              >
                <div class="flex items-center">
                  ...
                  >
                    <div
                      class="relative inline-block w-10 h-5 transition duration-200 ease-in-out mr-2"
                    >
                      <input
                        type="checkbox"
                        id="auto-pull"
            ...
            >
              ...
              >
                <div
                  class="px-4 py-3 border-b dark:border-gray-700 flex items-center justify-between"
                >
                  <div class="flex items-center">
                    <!-- Alarm Toggle Switch -->
                  ...
                  <h4
                    class="flex-grow text-center font-bold text-gray-700 dark:text-gray-200"
                  >
                    {{ sensor.name }}
                    <span v-if="modbusResult?.[sensor.id]?.success"
                      >- {{ modbusResult[sensor.id].data }}</span
                    >
                  </h4>
                ...
                <div class="p-4 relative">
                  ...
                  <div
                    v-if="
                      sensorAlarmsEnabled[sensor.id] !== false &&
                      modbusResult?.[sensor.id]?.success &&
                      getAlertLevel(sensor, modbusResult[sensor.id].data) > 0 &&
                      !isAlertDismissed(
                        sensor.id,
                  ...
                  >
                    ...
                    <div class="mt-2 text-sm font-bold leading-tight uppercase">
                      ...
                      >
                        ...
                        <p class="mt-1">
                          No Classes in Kindergarten, Elementary & Secondary
                        </p>
                      </template>
                      <template
                        v-else-if="
                      ...
                      >
                        <p>
                          Evacuate and proceed to designated Evacuation Center.
                        </p>
                        <p class="mt-1">
                          No Classes in all levels. Work Suspension.
                        </p>
                      </template>
                    </div>

                    <div
                      class="mt-4 py-1 px-2 bg-white/20 rounded text-[10px] font-mono self-start"
                    >
                  ...
                  <div
                    v-else-if="
                      modbusResult?.[sensor.id] &&
                      !modbusResult?.[sensor.id]?.success
                    "
                    class="bg-red-50 dark:bg-red-900/10 text-red-700 dark:text-red-300 rounded-lg p-6"
                  >
                    <p class="font-bold mb-2 text-sm text-center">
                      Connection Issue
                    </p>
                    <p
                      class="text-xs text-center line-clamp-2"
                      :title="modbusResult[sensor.id].error"
                    >
                      {{ modbusResult[sensor.id].error }}
                    </p>
                    <p class="text-[10px] text-center mt-2 opacity-50">
                      {{ modbusResult[sensor.id].timestamp }}
                    </p>
                  </div>
                  <!-- Waiting for Data -->
                  <div
                  ...
                  >
                    <svg
                      class="w-12 h-12 mb-3 animate-pulse"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div class="overflow-hidden">
            ...
            >
              ...
              >
                  ...
                  <div class="w-full md:w-2/5 p-6 flex flex-col">
                    ...
                    <div class="flex justify-between items-start mb-4">
                      <div class="flex flex-col">
                        <h4
                          class="text-2xl font-bold text-gray-800 dark:text-gray-100 uppercase leading-none"
                        >
                          {{ station.name }}
                        </h4>
                        <span class="text-xs text-gray-500 mt-1 italic"
                          >ID: {{ station.station_id }}</span
                        >
                        <span
                          v-if="
                            weatherResult[station.id].success &&
                          ...
                          "
                          class="text-[10px] font-light text-gray-400 italic mt-1"
                        >
                          last update:
                          {{ weatherResult[station.id].data.date_time }}
                        </span>
                      </div>
                      <div
                        :class="
                      ...
                      >
                        ...
                        >
                          <path
                            d="M17.5 19c2.5 0 4.5-2 4.5-4.5 0-2.3-1.7-4.2-3.9-4.5.3-.6.4-1.2.4-1.8 0-2.3-1.8-4.2-4.1-4.2-1.7 0-3.2 1-3.8 2.5C9.8 6.2 9 6 8.2 6c-2.3 0-4.2 1.8-4.2 4.1 0 .4.1.8.2 1.2C2.1 11.8 1 13.3 1 15c0 2.2 1.8 4 4 4h12.5z"
                          />
                    ...
                    <div
                      v-if="weatherResult[station.id].success"
                    ...
                    >
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        ...
                        <div
                          class="flex flex-col pl-4 border-l border-gray-100 dark:border-gray-700"
                        >
                          <span
                            class="text-[10px] font-bold text-gray-400 uppercase tracking-wider"
                            >Rain Total</span
                      ...
                      <div class="grid grid-cols-2 gap-x-8 gap-y-4">
                        <div class="flex flex-col">
                          ...
                          >
                          <div
                            class="flex items-baseline font-bold text-gray-700 dark:text-gray-200 text-lg"
                          >
                            <span>{{
                              Number(
                                weatherResult[station.id].data.temperature
                              ).toFixed(1)
                            }}</span>
                        ...
                        <div class="flex flex-col">
                          ...
                          >
                            <span>{{
                              Number(
                                weatherResult[station.id].data.dewpoint
                              ).toFixed(2)
                            }}</span>
                            <span class="ml-0.5 text-xs font-normal">°C</span>
                          </div>
                        ...
                        <div class="flex flex-col">
                          ...
                          >
                            <span>{{
                              Number(
                                weatherResult[station.id].data.humidity
                              ).toFixed(2)
                            }}</span>
                        ...
                        <div class="flex flex-col">
                          ...
                          >
                            <span>{{
                              Number(
                                weatherResult[station.id].data.heat_index
                              ).toFixed(1)
                            }}</span>
                            <span class="ml-0.5 text-xs font-normal">°C</span>
                          </div>
                      ...
                      <div class="grid grid-cols-2 gap-4 items-center pt-2">
                        <div class="flex flex-col">
                          ...
                          >
                          <div
                            class="flex items-baseline font-bold text-gray-700 dark:text-gray-200 text-lg mt-1"
                          >
                            <span>{{
                              Math.round(
                                weatherResult[station.id].data.pressure
                              )
                            }}</span>
                          ...
                          <div class="mt-4 flex flex-col">
                            ...
                            >
                            <div
                              class="flex items-baseline text-gray-700 dark:text-gray-200 font-bold"
                            >
                              <span class="text-xl">{{
                                Number(
                                  weatherResult[station.id].data.wind_speed
                                ).toFixed(2)
                              }}</span>
                              ...
                              <span class="text-xl">{{
                                Number(
                                  weatherResult[station.id].data.wind_gust
                                ).toFixed(0)
                              }}</span>
                              <span
                    ...
                    <div
                      v-else
                      class="bg-red-50 dark:bg-red-900/10 text-red-700 dark:text-red-300 rounded-lg p-4"
                    >
                      <p class="font-bold mb-2 text-xs text-center">
                        Connection Issue
                      </p>
                      <p
                        class="text-[10px] text-center line-clamp-2"
                        :title="weatherResult[station.id].error"
                      >
                        {{ weatherResult[station.id].error }}
                      </p>
                      <p class="text-[9px] text-center mt-2 opacity-50">
                        {{ weatherResult[station.id].timestamp }}
                      </p>
                    </div>
                  </div>
                </template>
                <template v-else>
                  <div
                    class="w-full p-12 flex flex-col items-center justify-center text-gray-400"
                  >
                    <svg
                      class="w-12 h-12 mb-4 animate-pulse"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <p class="text-sm italic">
                      Syncing weather data for {{ station.name }}...
                    </p>
                  </div>
                </template>
              </div>
        ...
        >
          ...
          <div class="overflow-hidden mb-6">
            ...
            <div
              v-if="evacuationCenters && evacuationCenters.length > 0"
              class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
            >
              <div
                v-for="center in evacuationCenters"
                :key="center.id"
                class="bg-white dark:bg-gray-800 border-2 border-orange-500 rounded-xl shadow-md p-4 relative overflow-hidden group hover:shadow-md transition-shadow"
              >
                <div class="flex items-start space-x-4">
                  ...
                  <div class="flex-grow min-w-0">
                    <h4
                      class="text-lg font-bold text-gray-800 dark:text-gray-100 uppercase truncate border-b-2 border-gray-300 dark:border-gray-600 pb-1 mb-2"
                    >
                      {{ center.name }}
                    </h4>
                    ...
                    <div class="space-y-1">
                      <div class="text-sm text-gray-600 dark:text-gray-300">
                        <span
                          ...
                          >Occupants:</span
                        >
                        <span class="font-bold ml-1 text-base"
                      ...
                      <div class="text-sm font-bold flex items-center">
                        <span
                          class="uppercase text-[10px] tracking-wider text-gray-500 dark:text-gray-400 mr-1"
                          >Status:</span
                        >
                        <span
                          :class="{
                            'text-red-600':
                              Number(center.curren_resident) /
                                Number(center.max_capacity) >=
                              1,
                ...
                <div
                  class="absolute -right-4 -bottom-4 w-24 h-24 bg-gray-50 dark:bg-gray-700/50 rounded-full -z-0 pointer-events-none"
                ></div>
              </div>
            </div>
