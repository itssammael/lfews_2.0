...
const cleanData = () => {
  ...
  const unitRegex =
    /\s*(?:°|%|°in|°F|°C|in|%RH|mph|km\/h|Pa|hPa|mb|mbar|mm)\s*/gi;
...
const targetOptions = computed(() => {
  return targetType.value === "weather_station"
    ...
    >
      <div class="max-w-[1800px] mx-auto px-4 h-full">
        <div class="grid grid-cols-12 gap-8 h-full overflow-hidden">
          ...
          <div
            class="col-span-12 lg:col-span-2 h-full flex flex-col space-y-6 overflow-y-auto pr-2 scrollbar-thin"
          >
            <!-- Settings Section -->
            <div
              class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 shrink-0"
            >
              <h3
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    class="w-full bg-gray-50 dark:bg-gray-900 border-transparent focus:border-orange-500 focus:ring-0 rounded-xl text-xs text-gray-700 dark:text-gray-300 py-2.5 px-3"
                  >
                    <option value="weather_station">
                      Weather Station Observation Data
                    </option>
                    <option value="water_level_sensor">
              ...
              <div class="space-y-4">
                <div class="flex items-center space-x-3">
                  <label class="cursor-pointer">
                    <span
                      class="inline-flex items-center px-4 py-2 bg-orange-50 hover:bg-orange-100 text-orange-600 text-sm font-medium rounded-full transition-all duration-200 border border-orange-100"
                    >
                      Choose File
                    </span>
                    <input
                ...
                <div class="pt-4 border-t border-gray-50 dark:border-gray-700">
                  ...
                  <div class="space-y-2">
                    ...
                    >
                      <svg
                        class="size-3.5 mr-2 text-gray-400 group-hover:text-orange-500 transition-colors"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    >
                      ...
                      <span class="text-xs font-medium"
                        >Water Level Sensor Template</span
                      >
                    </button>
                  </div>
                </div>
          ...
          <div class="col-span-12 lg:col-span-10 h-full overflow-hidden">
            <div
              class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 h-full flex flex-col overflow-hidden"
            >
              <!-- Spreadsheet Header -->
              <div
                v-if="uploadedData.length > 0"
                class="px-6 py-4 border-b border-gray-50 dark:border-gray-700 flex items-center justify-between bg-white dark:bg-gray-800 rounded-t-2xl sticky top-0 z-10"
              >
                <div class="flex items-center space-x-6">
                  ...
                  <div
                    ...
                    class="flex flex-col space-y-2 border-l border-gray-100 dark:border-gray-700 pl-6"
                  >
                    <label
                    ...
                    >
                      ...
                      />
                      <div
                        class="w-9 h-5 bg-gray-200 peer-focus:outline-none dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-orange-500 rounded-full"
                      ></div>
                      <span
                        class="ml-3 text-[10px] font-bold text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-all uppercase tracking-widest whitespace-nowrap"
                      >
                        Convert °F to °C
                      </span>
                    </label>
                  ...
                  <div
                    class="flex items-center space-x-2 border-l border-gray-100 dark:border-gray-700 pl-6"
                  >
                    <button
                      @click="resetData"
              ...
              <div class="flex-grow overflow-hidden flex flex-col">
                <template v-if="uploadedData.length > 0">
                  <div
                    class="overflow-auto flex-grow scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700"
                  >
                    <table class="w-full text-left border-collapse">
                      <thead
                        class="bg-gray-50 dark:bg-gray-900/50 sticky top-0 z-10"
                      >
                        <tr>
                          <th
                          ...
                          <th
                            class="px-4 py-2.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 dark:border-gray-700 text-right"
                          >
                            Actions
                          </th>
                        </tr>
                        ...
                        >
                          ...
                          >
                            <input
                              ...
                              :value="row[col]"
                              @input="
                                updateCell(row.originalIndex, col, $event)
                              "
                          ...
                          <td class="px-4 py-1.5 text-right">
                            <button
                              @click="removeRow(row.originalIndex)"
                  ...
                  <!-- Pagination Controls -->
                  <div
                    class="px-6 py-4 border-t border-gray-50 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-b-2xl flex items-center justify-between"
                  >
                    <div
                    ...
                    >
                      ...
                      to
                      <span class="text-gray-900 dark:text-gray-200">{{
                        Math.min(currentPage * rowsPerPage, uploadedData.length)
                      }}</span>
                      of
                      <span class="text-gray-900 dark:text-gray-200">{{
                        uploadedData.length
                ...
                <template v-else>
                  ...
                  >
                    <div class="relative mb-8">
                      <div
                        class="absolute inset-0 bg-orange-100 dark:bg-orange-500/10 rounded-full blur-3xl opacity-50 animate-pulse"
                      ></div>
                      <svg
                        class="size-24 text-gray-300 dark:text-gray-600 relative"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
